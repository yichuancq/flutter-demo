...
/// 获取网络数据
Future<EarthQuakeInfoDTO> getEarthInfoPagesHttp(int page,int typeNumber) async {
  try {
    //http://www.ceic.ac.cn/ajax/search?page=1&&start=2019-07-15&&end=2019-07-15&&jingdu1=&&jingdu2=&&weidu1=&&weidu2=&&height1=&&height2=&&zhenji1=&&zhenji2=&&callback=
    ...
    final String url = "http://www.ceic.ac"
        ".cn/ajax/speedsearch?num=$typeNumber&&page=$page&&callback""=jQuery18004632403418509128_1563550548942&_=1563553564961";
